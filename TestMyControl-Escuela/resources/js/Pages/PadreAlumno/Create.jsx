                        ...
                        <div className="p-6 text-gray-900">
                            <form onSubmit={submit}>
                                ...
                                <div className="mt-4">
                                    <InputLabel
                                        htmlFor="id_padre"
                                        value="Selecciona un Responsable"
                                    />
                                    <select
                                        id="id_padre"
                                        name="id_padre"
                                        value={data.id_padre}
                                        onChange={(e) =>
                                            setData("id_padre", e.target.value)
                                        }
